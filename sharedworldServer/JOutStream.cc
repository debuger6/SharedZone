...
{
	uint16 be16 = muduo::net::sockets::hostToNetwork16(x);
...
{
	uint32 be32 = muduo::net::sockets::hostToNetwork32(x);
...
{
	int16 be16 = muduo::net::sockets::hostToNetwork16(x);
	Append(&be16, sizeof be16);
	return *this;
}
...
{
	int32 be32 = muduo::net::sockets::hostToNetwork32(x);
	Append(&be32, sizeof be32);
	return *this;
}
